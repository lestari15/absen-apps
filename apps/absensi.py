...
if nama == detected_name and label_name == 'real':
    ...
    if(mycursor.rowcount == 1):
        ...
        webbrowser.open(
            "http://absenwajah.ubl.ac.id:3030/karyawan/absen_karyawan?data=berhasil", new=0, autoraise=True)
else:
    print("Gak Boleh absen")
    webbrowser.open(
            "http://absenwajah.ubl.ac.id:3030/karyawan/absen_karyawan?data=gagal", new=0, autoraise=True)